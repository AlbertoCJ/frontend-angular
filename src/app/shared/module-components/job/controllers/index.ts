import { ControllerSetectDatasetComponent } from './controller-setect-dataset/controller-setect-dataset.component';
import { ControllerAlgorithmConfigComponent } from './controller-algorithm-config/controller-algorithm-config.component';
...
export const JOB_CONTROLLERS = [
    ...
    ControllerAlgorithmConfigComponent,
